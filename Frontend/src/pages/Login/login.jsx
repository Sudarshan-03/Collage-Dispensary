...
const Login = (props) => {
    ...
    const handleLogin = async () => {
        ...
        await axios.post('https://backend-ruddy-iota-64.vercel.app/api/auth/login', loginField, { withCredentials: true }).then((response) => {
    ...
    const handleRegister = async () => {
        ...
        props.showLoader();
        await axios.post('https://backend-ruddy-iota-64.vercel.app/api/auth/register', registerField).then(response => {
